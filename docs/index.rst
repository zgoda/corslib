...
By default generated headers provide relaxed security appropriate for development yet still within CORS specification. The default access model allows open *web safe* operation, similar to pre-CORS browser mode.
